document.addEventListener('DOMContentLoaded', () => {
    // Facebook in-app browser detection and external browser button
    const fbOpenInBrowserBtn = document.getElementById('fb-open-in-browser');
    ...
    // Show button only if in Facebook browser
